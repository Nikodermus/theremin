/*!
 * @nikodermus/react-theremin v0.0.1 - https://nikodermus.github.ui/theremin
 * MIT Licensed
 */
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Theremin"] = factory(require("react"));
	else
		root["Theremin"] = factory(root["React"]);
...
var _flattenNames = __webpack_require__(87);

var _flattenNames2 = _interopRequireDefault(_flattenNames);

var _mergeClasses = __webpack_require__(159);

var _mergeClasses2 = _interopRequireDefault(_mergeClasses);

var _autoprefix = __webpack_require__(179);

var _autoprefix2 = _interopRequireDefault(_autoprefix);

var _hover2 = __webpack_require__(180);

var _hover3 = _interopRequireDefault(_hover2);

var _active = __webpack_require__(181);

var _active2 = _interopRequireDefault(_active);

var _loop2 = __webpack_require__(182);
...
var _Alpha = __webpack_require__(183);
...
var _Checkboard = __webpack_require__(46);
...
var _EditableInput = __webpack_require__(186);
...
var _Hue = __webpack_require__(187);
...
var _Raised = __webpack_require__(189);
...
var _Saturation = __webpack_require__(203);
...
var _ColorWrap = __webpack_require__(79);
...
var _Swatch = __webpack_require__(211);
...
var _each = __webpack_require__(208);

var _each2 = _interopRequireDefault(_each);

var _tinycolor = __webpack_require__(210);
...
var isObject = __webpack_require__(6),
    ...
    toNumber = __webpack_require__(206);
...
var _Alpha = __webpack_require__(86);
...
var _Block = __webpack_require__(214);
...
var _Chrome = __webpack_require__(218);
...
var _Compact = __webpack_require__(223);
...
var _Twitter = __webpack_require__(248);
...
var _AlphaPointer = __webpack_require__(213);
...
var _isString2 = __webpack_require__(88);

var _isString3 = _interopRequireDefault(_isString2);

var _forOwn2 = __webpack_require__(29);

var _forOwn3 = _interopRequireDefault(_forOwn2);

var _isPlainObject2 = __webpack_require__(53);
...
var _cloneDeep2 = __webpack_require__(160);
...
var Stack = __webpack_require__(20),
    ...
    getAllKeys = __webpack_require__(59),
...
var _alpha = __webpack_require__(184);
...
var _hue = __webpack_require__(188);
...
var _interaction = __webpack_require__(212);
...
var _BlockSwatches = __webpack_require__(215);
...
var _materialColors = __webpack_require__(80);

var material = _interopRequireWildcard(_materialColors);

var _common = __webpack_require__(3);

var _CircleSwatch = __webpack_require__(217);
...
var _ChromeFields = __webpack_require__(219);

var _ChromeFields2 = _interopRequireDefault(_ChromeFields);

var _ChromePointer = __webpack_require__(221);

var _ChromePointer2 = _interopRequireDefault(_ChromePointer);

var _ChromePointerCircle = __webpack_require__(222);
...
var _UnfoldMoreHorizontalIcon = __webpack_require__(220);
...
var _CheckIcon = __webpack_require__(247);
...
var setInRange = function setInRange(val) {
...
// EXTERNAL MODULE: ./src/styles/AddNote.styl
var AddNote = __webpack_require__(249);

// CONCATENATED MODULE: ./src/Components/AddNote.jsx
var AddNote_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
const AddNote_AddNote = ({ addNote, notes }) => {
    const [note, setNote] = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useState"])({
        color: '#75ffff',
        modifier: 0
    });
    ...
    const changeNote = ({ target }) => {
        ...
        setNote(prevState => AddNote_extends({}, prevState, { [name]: value }));
    };

    const changeColor = ({ hex }) => {
        setNote(prevState => AddNote_extends({}, prevState, { color: hex }));
    };

    const { modifier, color } = note;
    const disabled = notes.some(activeNote => activeNote.modifier === Number(modifier));
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
        ...
        external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
            ...
            external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
                ...
                external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(lib["GithubPicker"], {
                    color: color,
                    onChangeComplete: changeColor,
                    colors: ['#004dcf', '#006b76', '#008b02', '#5300eb', '#75ffff', '#b80000', '#bedadc', '#c1e1c5', '#c4def6', '#db3e00', '#eb9694', '#fad0c3', '#fccb00', '#fef3bd']
                })
            )
        )
    );
...
AddNote_AddNote.propTypes = {
    addNote: prop_types_default.a.func.isRequired,
    notes: prop_types_default.a.arrayOf(prop_types_default.a.shape({
        color: prop_types_default.a.string.isRequired,
        modifier: prop_types_default.a.number
    }))
};

/* harmony default export */ var Components_AddNote = (AddNote_AddNote);
// EXTERNAL MODULE: ./src/styles/Note.styl
var Note = __webpack_require__(251);

// CONCATENATED MODULE: ./src/Components/Note.jsx
...
const Note_Note = ({
    ...
    const [oscillator, setOscillator] = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useState"])(null);
    ...
    Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useEffect"])(() => {
        ...
        oscillator.frequency.setValueAtTime(600 * toneModifier + modifier, audio.currentTime);
    }, [toneModifier]);

    return withNotes ? external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
        'div',
        { className: '_note' },
        external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
            'span',
            { style: { color }, className: '_note__tone' },
            '\u266C'
        ),
        external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
            'button',
...
Note_Note.propTypes = {
    audio: prop_types_default.a.instanceOf(window.AudioContext || window.webkitAudioContext).isRequired,
    color: prop_types_default.a.string.isRequired,
    modifier: prop_types_default.a.number.isRequired,
    removeNote: prop_types_default.a.func.isRequired,
    volume: prop_types_default.a.instanceOf(GainNode).isRequired,
    toneModifier: prop_types_default.a.number.isRequired
};

/* harmony default export */ var Components_Note = (Note_Note);
// EXTERNAL MODULE: ./src/styles/PitchVisualizer.styl
var PitchVisualizer = __webpack_require__(253);

// CONCATENATED MODULE: ./src/Components/PitchVisualizer.jsx
...
const PitchVisualizer_PitchVisualizer = ({ tones, toneModifier, playing }) => {
    const tonesInRange = setInRange(tones, 10, 50);
    const [tonesAmount, setTonesAmount] = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useState"])(Array(tonesInRange).fill(''));
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
        ...
        tonesAmount.map((el, index) => {
            ...
            return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement('span', {
                className: `_pitch-visualizer__tone ${index <= visible && playing ? '_pitch-visualizer__tone--active' : ''}`,
                key: index
            });
        })
    );
...
PitchVisualizer_PitchVisualizer.propTypes = {
    tones: prop_types_default.a.arrayOf(prop_types_default.a.shape({
...
/* harmony default export */ var Components_PitchVisualizer = (PitchVisualizer_PitchVisualizer);
// EXTERNAL MODULE: ./src/styles/Theremin.styl
var Theremin = __webpack_require__(255);

// CONCATENATED MODULE: ./src/Components/Theremin.jsx
var Theremin_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
const Theremin_Theremin = (_ref) => {
    let {
        ...
        rest = _objectWithoutProperties(_ref, ['className', 'withPitch', 'withVolume', 'withAdd', 'withNotes', 'notes']);

    const thRef = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useRef"])(null);
    const [state, setState] = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useReducer"])(reducer, initialState);
    ...
    const volumePercent = playing ? setInRange((volumeModifier - 1.5) * 100) : 0;
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
        ...
        null,
        withPitch && external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Components_PitchVisualizer, {
            playing: playing,
        ...
        external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
            'div',
            { className: '_th-board' },
            withVolume && external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement('span', {
                className: '_th-volume',
                style: {
                    backgroundImage: `linear-gradient(to bottom,#74ffff ${volumePercent}%, #fff ${volumePercent + 10}%)`
                }
            }),
            external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement('div', Theremin_extends({}, rest, {
                className: `${className} _th-theremin`,
                onMouseEnter: () => setState({ playing: true && notes.length }),
                onMouseLeave: () => setState({ playing: false }),
                onMouseMove: onMouseMove,
                ref: thRef
            }))
        ),
        withAdd && external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Components_AddNote, { addNote: addNote, notes: notes }),
        external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
            'div',
            { className: '_note__wrapper', hidden: withNotes || undefined },
            notes.map(note => external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Components_Note, Theremin_extends({}, note, {
                audio: audio,
                key: note.modifier,
                playing: playing,
...
Theremin_Theremin.propTypes = {
    className: prop_types_default.a.string,
    withPitch: prop_types_default.a.bool,
    withVolume: prop_types_default.a.bool,
    withAdd: prop_types_default.a.bool,
    withNotes: prop_types_default.a.bool,
    notes: prop_types_default.a.arrayOf(prop_types_default.a.shape({
        modifier: prop_types_default.a.number.isRequired,
        color: prop_types_default.a.string
    }))
...
Theremin_Theremin.defaultProps = {
    className: '',
    withPitch: true,
    withVolume: true,
    withAdd: true,
...
/* harmony default export */ var Components_Theremin = (Theremin_Theremin);
// CONCATENATED MODULE: ./src/index.js




/* harmony default export */ var src = __webpack_exports__["default"] = (Object(root["hot"])(Components_Theremin));
